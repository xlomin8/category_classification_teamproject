...
X_train, X_test, Y_train, Y_test = np.load('./crawled_data/joonggo_data_max_30_wordsize_16350_Kkma.npy', allow_pickle=True)
...
model.add(Embedding(20927, 300, input_length=30))
